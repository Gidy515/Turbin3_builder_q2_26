...
impl <'info> Refund<'info> {
    // Refund the maker's deposit back to them and close the vault and escrow accounts
    pub fn withdraw_and_close_vault(&mut self) -> Result<()> {
        ...
        let close_cpi_context = CpiContext::new_with_signer(self.token_program.key(), cpi_close_accounts, &signer_seeds);
