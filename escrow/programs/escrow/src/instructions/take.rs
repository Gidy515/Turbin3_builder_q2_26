...
impl <'info> Take<'info> {
    ...
    // Withdraw the tokens a from the vault to the taker and close the vault
    pub fn withdraw_and_close_vault(&mut self) -> Result<()> {
        ...
        let close_cpi_context = CpiContext::new_with_signer(self.token_program.key(), close_cpi_accounts, &signer_seeds);
